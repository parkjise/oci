...
import { useSlipReversePopupStore } from "@/store/fcm/gl/slip/popup/SlipReversePopupStore";
import type { SlipReversePopupProps, SlipReversePopupRequest } from "@/types/fcm/gl/slip/popup/SlipReversePopup.types";
...
const SlipReversePopup: FC<SlipReversePopupProps & InjectedProps<any>> = ({ initialData, returnValue, setConfirmHandler }) => {
    const [form] = Form.useForm();
    const { handleReverseSlip } = useSlipReversePopupStore();
    ...
    const handleConfirm = async () => {
        try {
            ...
            const request: SlipReversePopupRequest = {
            ...
            const success = await handleReverseSlip(request);
                    ...
                    <PopupTable>
                        <tbody>
                            ...
                            <tr>
                                <th>역분개 유형</th>
                                <td colSpan={3}>
                                    <Form.Item name="reverseType">
                                        <Radio.Group>
                                            <Radio value="1">Sign</Radio>
                                            <Radio value="2">Switch</Radio>
                                        </Radio.Group>
                                    </Form.Item>
                                </td>
                            </tr>
...
export default SlipReversePopup;
