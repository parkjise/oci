...
const Sample2: React.FC = () => {
  return (
    <Article className="page-layout">
      {/* 조회 */}
      <FilterPanel className="page-layout__filter-panel card" />
      {/* 조회 결과 */}
      <Detail
        left={<RecordList className="page-layout__record-list card" />} // 상세 리스트
        right={
          <>
            {/*상세 화면 */}
            <DetailView className="page-layout__detail-view card" />
            {/*상세 Grid */}
            <DetaiGrid className="page-layout__detail-grid card" />
          </>
        }
      />
    </Article>
