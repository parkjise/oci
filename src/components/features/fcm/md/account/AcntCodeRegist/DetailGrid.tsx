  ...
  const columnDefs: ExtendedColDef<GridRowData>[] = useMemo(
    () => {
      ...
      return [
        ...
        // 4. Output Names
        { field: "accOutName1", headerName: "출력명 1", width: 150, minWidth: 150, maxWidth: 150, editable: true },
        { field: "accOutName2", headerName: "출력명 2", width: 150, minWidth: 150, maxWidth: 150, editable: true },
        { field: "accOutName3", headerName: "출력명 3", width: 150, minWidth: 150, maxWidth: 150, editable: true },
        { field: "accOutName4", headerName: "출력명 4", width: 150, minWidth: 150, maxWidth: 150, editable: true },
        // 5. Display Options
        {
          field: "cdtDbtYn",
          headerName: "지출결의직적입력",
