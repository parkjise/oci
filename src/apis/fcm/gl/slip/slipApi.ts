...
export const createSlipHderId = async (
  ...
  return await post<SlipHderResponse>("/fcm/gl/slip/createSlipHderId", request);
};
...
export const selectSlipHderId = async (
  ...
  return await post<SlipHderResponse>("/fcm/gl/slip/selectSlipHderId", request);
};
...
export const selectHderList = async (
  ...
  return await post<SlipHderResponse>("/fcm/gl/slip/selectHderList", request);
};
...
export const saveHderDetail = async (
  request: SlipSaveRequest
): Promise<ApiResponse<void>> => {
  return await post<void>("/fcm/gl/slip/saveHderDetail", request);
};
...
export const saveCopyHderDetail = async (
  ...
  return await post<void>("/fcm/gl/slip/saveCopyHderDetail", request);
};
...
export const deleteHderDetail = async (
  ...
  return await post<void>("/fcm/gl/slip/deleteHderDetail", request);
};
...
): Promise<ApiResponse<ConfmResponse[]>> => {
  return await post<ConfmResponse[]>("/fcm/gl/slip/selectConfmList", request);
};
